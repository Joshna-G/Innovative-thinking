...
export default function MusicPlayer({ spotifyLink }: MusicPlayerProps) {
  return (
    <div className="d-flex align-items-center justify-content-center gap-1 gap-md-3 position-relative">
      <div 
        className="d-block" 
      ...
      >
        <motion.div 
          className="position-relative bg-dark rounded-4 p-3 border border-secondary shadow-lg overflow-hidden mt-3 mt-md-5" 
          style={{ 
            width: "240px", 
            height: "120px",
            cursor: "pointer", 
            boxShadow: "0 0 25px rgba(220, 53, 69, 0.4), inset 0 0 10px rgba(255,255,255,0.05)" 
          }}
          whileHover="hover"
        >
