  ...
  useEffect(() => {
    ...
    function handleFirstTouchStart(e: TouchEvent) {
      if (e.touches.length > 0) {
        ...
        // Remove the listener once started to avoid re-triggering init logic
    ...
    window.addEventListener(
      ...
      e => {
        if (e.touches.length > 0) {
          ...
          const posX = scaleByPixelRatio(touch.clientX);
          const posY = scaleByPixelRatio(touch.clientY);
          // On every touch start, generate a new color and update position
          updatePointerDownData(pointer, touch.identifier, posX, posY);
        }
      },
      false
    ...
    window.addEventListener(
      ...
      e => {
        if (e.touches.length > 0) {
          ...
          const posX = scaleByPixelRatio(touch.clientX);
          const posY = scaleByPixelRatio(touch.clientY);
          // Update movement to trigger splat
